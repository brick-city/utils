...
/**
 *
 * Takes a SQL Server cdc update mask represented as a buffer, and returns
...
export const updateMaskToBooleanArray = (updateMask) => {
...
export const updateMaskToBitArray = (updateMask) => {
